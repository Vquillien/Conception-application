...
public class testAppliS {
    ...
    public void Scenario(){
    	...
    	int indexQ1 = (int) monAppliS.ajouterQuestionnaire("QuestHebdo1", "2010-09-10", "2010-10-10");
    	...
    	monAppliS.modifierQuestionnaireDateDebut(indexQ1, "2010-09-12");
    	int indexS = monAppliS.getIndexSportif("titi");
    	int indexQR = monAppliS.ajouterQuestionReponse(indexS, indexQ1);
    	ArrayList<Boolean> b = new ArrayList<Boolean>();
    	b.add(false);
    	b.add(true);
    	monAppliS.repondreQuestionReponse(b, indexQR,"2010-09-20");
